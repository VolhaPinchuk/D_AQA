...
class DashDLOnes00075Cest
{
	...
	//change type from Open Promo
    public function changetypeopenpromo(DashAcceptanceTester $I)
    {
		//variables
		$popup = '.toast-message';
		$Open_Promo = '//*[contains(@class,"VContextMenu__item")][contains(text(),"Open Promo")]';
		...
		$I->click($down_arr);
		$I->waitForElementClickable($Open_Promo, 20);
		$I->click($Open_Promo);
		$I->loader();
		...
		//CHANGE TYPE AND RETURN TO Open Promo
		for($i = 1; $i <= $itNumber; $i++){
			
			//open dropdown of Open Promo
