...
class DashDLOnes00076Cest
{
	...
	//change type from Transfer
    public function changetypetransfer(DashAcceptanceTester $I)
    {
		//variables
		$popup = '.toast-message';
		$Transfer = '//*[contains(@class,"VContextMenu__item")][contains(text(),"Transfer")]';
		...
		$I->click($down_arr);
		$I->waitForElementClickable($Transfer, 20);
		$I->click($Transfer);
		$I->loader();
		...
		//CHANGE TYPE AND RETURN TO Transfer
		for($i = 1; $i <= $itNumber; $i++){
			
			//open dropdown of Transfer
