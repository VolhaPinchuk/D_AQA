...
class DashDLOnes00074Cest
{
	...
	//change type from On Hold
    public function changetypeonhold(DashAcceptanceTester $I)
    {
		//variables
		$popup = '.toast-message';
		$On_Hold = '//*[contains(@class,"VContextMenu__item")][contains(text(),"On Hold")]';
		...
		$I->click($down_arr);
		$I->waitForElementClickable($On_Hold, 20);
		$I->click($On_Hold);
		$I->wait(1);
		...
		//CHANGE TYPE AND RETURN TO On Hold
		for($i = 1; $i <= $itNumber; $i++){
			
			//open dropdown of On Hold
